...
|GET /ariel/databases/{database_name}|def get_databases_by_database_name(self, database_name, *, fields=None, filter=None, Range=None, **kwargs):|application/json|STABLE|
...
|GET /ariel/event_saved_search_groups|def get_event_saved_search_groups(self, *, Range=None, filter=None, fields=None, **kwargs):|application/json|STABLE|
...
|GET /ariel/flow_saved_search_groups|def get_flow_saved_search_groups(self, *, Range=None, filter=None, fields=None, **kwargs):|application/json|STABLE|
...
|GET /ariel/flow_vlans|def get_flow_vlans(self, *, Range=None, filter=None, fields=None, **kwargs):|application/json|STABLE|
...
|GET /ariel/function/{function_name}|def get_function_by_function_name(self, function_name, *, Range=None, filter=None, fields=None, **kwargs):|application/json|UNDOCUMENTED|
...
| API | QRadar4py | Return type | Visibility |
|-----|-----------|--------------|------------|
|GET /config/access/authorized_services|def get_access_authorized_services(self, *, Range=None, filter=None, fields=None, **kwargs):|application/json|UNDOCUMENTED|
...
|GET /config/access/roles|def get_access_roles(self, *, Range=None, filter=None, fields=None, **kwargs):|application/json|UNDOCUMENTED|
|GET /config/access/roles/{id}|def get_access_roles_by_id(self, id, *, fields=None, **kwargs):|application/json|UNDOCUMENTED|
|GET /config/access/security_profiles|def get_access_security_profiles(self, *, tenant_id=None, current_security_profile=None, Range=None, filter=None, fields=None, **kwargs):|application/json|STABLE|
...
|GET /config/access/staged_authorized_services|def get_access_staged_authorized_services(self, *, Range=None, filter=None, fields=None, **kwargs):|application/json|UNDOCUMENTED|
...
|GET /config/access/staged_roles|def get_access_staged_roles(self, *, Range=None, filter=None, fields=None, **kwargs):|application/json|UNDOCUMENTED|
...
|GET /config/access/tenant_management/tenants|def get_access_tenant_management_tenants(self, *, Range=None, filter=None, fields=None, **kwargs):|application/json|STABLE|
...
|GET /config/access/user_roles|def get_access_user_roles(self, *, contains=None, Range=None, filter=None, fields=None, **kwargs):|application/json|STABLE|
|GET /config/access/user_roles/{id}|def get_access_user_roles_by_id(self, id, *, fields=None, **kwargs):|application/json|STABLE|
|GET /config/access/users|def get_access_users(self, *, current_user=None, sort=None, Range=None, filter=None, fields=None, **kwargs):|application/json|STABLE|
...
|GET /config/access/users_with_capability_filter|def get_access_users_with_capability_filter(self, *, capabilities, Range=None, filter=None, fields=None, **kwargs):|application/json|UNDOCUMENTED|
|GET /config/access_control/roles|def get_access_control_roles(self, *, Range=None, filter=None, fields=None, **kwargs):|application/json|UNDOCUMENTED|
...
|GET /config/event_sources/custom_properties/property_nvp_expressions|def get_event_sources_custom_properties_property_nvp_expressions(self, *, filter=None, fields=None, Range=None, **kwargs):|application/json|STABLE|
...
| API | QRadar4py | Return type | Visibility |
|-----|-----------|--------------|------------|
|GET /staged_config/access/security_profiles|def get_access_security_profiles(self, *, tenant_id=None, Range=None, filter=None, fields=None, **kwargs):|application/json|STABLE|
...
|GET /staged_config/access/user_roles|def get_access_user_roles(self, *, contains=None, Range=None, filter=None, fields=None, **kwargs):|application/json|STABLE|
...
|GET /staged_config/access/users|def get_access_users(self, *, sort=None, Range=None, filter=None, fields=None, **kwargs):|application/json|STABLE|
...
|GET /staged_config/access/users_with_capability_filter|def get_access_users_with_capability_filter(self, *, capabilities, Range=None, filter=None, fields=None, **kwargs):|application/json|UNDOCUMENTED|
...
|GET /staged_config/access_control/users|def get_access_control_users(self, *, Range=None, filter=None, fields=None, **kwargs):|application/json|UNDOCUMENTED|
...
|GET /staged_config/ca_certs|def get_ca_certs(self, *, Range=None, filter=None, fields=None, **kwargs):|application/json|UNDOCUMENTED|
...
|GET /staged_config/certificates/end_certificates|def get_certificates_end_certificates(self, *, Range=None, filter=None, fields=None, **kwargs):|application/json|UNDOCUMENTED|
...
|GET /staged_config/certificates/root_certificates|def get_certificates_root_certificates(self, *, Range=None, filter=None, fields=None, **kwargs):|application/json|UNDOCUMENTED|
...
|GET /staged_config/remote_networks|def get_remote_networks(self, *, Range=None, filter=None, fields=None, **kwargs):|application/json|STABLE|
...
|GET /staged_config/remote_services|def get_remote_services(self, *, Range=None, filter=None, fields=None, **kwargs):|application/json|STABLE|
...
|GET /system/authorization/capabilities|def get_authorization_capabilities(self, *, Range=None, filter=None, fields=None, **kwargs):|application/json|UNDOCUMENTED|
|GET /system/authorization/password_policies|def get_authorization_password_policies(self, *, Range=None, filter=None, fields=None, **kwargs):|application/json|STABLE|
...
|GET /system/information/encodings|def get_information_encodings(self, *, Range=None, filter=None, fields=None, **kwargs):|application/json|STABLE|
...
|GET /system/proxy_servers|def get_proxy_servers(self, *, Range=None, filter=None, fields=None, **kwargs):|application/json|STABLE|
...
|POST /system/server_connection_validator|def post_server_connection_validator(self, *, request_details, fields=None, **kwargs):|application/json|UNDOCUMENTED|
...
|GET /configuration/log_source_types|def get_log_source_types(self, *, excludeSystemTypes=None, filter=None, fields=None, sort=None, Range=None, **kwargs):|application/json|UNDOCUMENTED|
...
|GET /application/data_ingestion/qid_records|def get_data_ingestion_qid_records(self, *, qid=None, name=None, low_level_category_id=None, high_level_category_id=None, log_source_type_id=None, filter=None, fields=None, sort=None, Range=None, **kwargs):|application/json|UNDOCUMENTED|
...
| API | QRadar4py | Return type | Visibility |
|-----|-----------|--------------|------------|
|GET /analytics/ade_rules|def get_ade_rules(self, *, Range=None, filter=None, fields=None, **kwargs):|application/json|STABLE|
...
|GET /analytics/building_blocks|def get_building_blocks(self, *, Range=None, filter=None, fields=None, **kwargs):|application/json|STABLE|
...
|GET /analytics/building_blocks_with_data|def get_building_blocks_with_data(self, *, Range=None, filter=None, fields=None, **kwargs):|application/json|UNDOCUMENTED|
...
|GET /analytics/custom_actions/actions|def get_custom_actions_actions(self, *, Range=None, filter=None, fields=None, **kwargs):|application/json|STABLE|
...
|GET /analytics/custom_actions/interpreters|def get_custom_actions_interpreters(self, *, Range=None, filter=None, fields=None, **kwargs):|application/json|STABLE|
...
|GET /analytics/custom_actions/scripts|def get_custom_actions_scripts(self, *, Range=None, filter=None, fields=None, **kwargs):|application/json|STABLE|
...
|GET /analytics/rule_groups|def get_rule_groups(self, *, Range=None, filter=None, fields=None, **kwargs):|application/json|STABLE|
...
|GET /analytics/rules|def get_rules(self, *, Range=None, filter=None, fields=None, **kwargs):|application/json|STABLE|
...
|GET /analytics/rules_with_data|def get_rules_with_data(self, *, sort=None, Range=None, filter=None, fields=None, **kwargs):|application/json|UNDOCUMENTED|
...
|GET /reference_data/map_of_sets|def get_map_of_sets(self, *, Range=None, filter=None, fields=None, **kwargs):|application/json|STABLE|
...
|GET /reference_data/maps|def get_maps(self, *, Range=None, filter=None, fields=None, **kwargs):|application/json|STABLE|
...
|GET /reference_data/maps/{name}|def get_maps_by_name(self, name, *, namespace=None, Range=None, filter=None, fields=None, **kwargs):|application/json|STABLE|
...
|GET /reference_data/sets|def get_sets(self, *, Range=None, filter=None, fields=None, **kwargs):|application/json|STABLE|
...
|GET /reference_data/sets/search|def get_sets_search(self, *, value, Range=None, filter=None, fields=None, **kwargs):|application/json|UNDOCUMENTED|
|GET /reference_data/sets/{name}|def get_sets_by_name(self, name, *, namespace=None, Range=None, filter=None, fields=None, **kwargs):|application/json|STABLE|
...
|GET /reference_data/tables|def get_tables(self, *, Range=None, filter=None, fields=None, **kwargs):|application/json|STABLE|
...
|GET /health/metrics/config|def get_metrics_config(self, *, Range=None, filter=None, fields=None, **kwargs):|application/json|UNDOCUMENTED|
...
|GET /health/metrics/meta|def get_metrics_meta(self, *, Range=None, filter=None, fields=None, **kwargs):|application/json|UNDOCUMENTED|
...
|GET /health/metrics/qradar_metrics|def get_metrics_qradar_metrics(self, *, Range=None, filter=None, fields=None, **kwargs):|application/json|STABLE|
...
|GET /health/metrics/system_metrics|def get_metrics_system_metrics(self, *, Range=None, filter=None, fields=None, **kwargs):|application/json|STABLE|
...
| API | QRadar4py | Return type | Visibility |
|-----|-----------|--------------|------------|
|GET /qrm/model_groups|def get_model_groups(self, *, Range=None, filter=None, fields=None, **kwargs):|application/json|STABLE|
...
|GET /qrm/qrm_saved_search_groups|def get_qrm_saved_search_groups(self, *, Range=None, filter=None, fields=None, **kwargs):|application/json|STABLE|
...
|GET /qrm/question_groups|def get_question_groups(self, *, Range=None, filter=None, fields=None, **kwargs):|application/json|STABLE|
...
|GET /qrm/simulation_groups|def get_simulation_groups(self, *, Range=None, filter=None, fields=None, **kwargs):|application/json|STABLE|
...
|GET /qrm/topology_saved_search_groups|def get_topology_saved_search_groups(self, *, Range=None, filter=None, fields=None, **kwargs):|application/json|STABLE|
...
| API | QRadar4py | Return type | Visibility |
|-----|-----------|--------------|------------|
|GET /siem/local_destination_addresses|def get_local_destination_addresses(self, *, Range=None, filter=None, fields=None, **kwargs):|application/json|STABLE|
...
|GET /siem/offense_closing_reasons|def get_offense_closing_reasons(self, *, include_reserved=None, include_deleted=None, Range=None, filter=None, fields=None, **kwargs):|application/json|STABLE|
...
|GET /siem/offense_saved_search_groups|def get_offense_saved_search_groups(self, *, Range=None, filter=None, fields=None, **kwargs):|application/json|STABLE|
...
|GET /siem/offense_saved_searches|def get_offense_saved_searches(self, *, Range=None, filter=None, fields=None, **kwargs):|application/json|STABLE|
|DELETE /siem/offense_saved_searches/{id}|def delete_offense_saved_searches_by_id(self, id, *, Range=None, filter=None, fields=None, **kwargs):|application/json|STABLE|
|POST /siem/offense_saved_searches/{id}|def post_offense_saved_searches_by_id(self, id, *, saved_search, Range=None, filter=None, fields=None, **kwargs):|application/json|STABLE|
|GET /siem/offense_saved_searches/{id}|def get_offense_saved_searches_by_id(self, id, *, Range=None, filter=None, fields=None, **kwargs):|application/json|STABLE|
...
|GET /siem/offense_types|def get_offense_types(self, *, sort=None, Range=None, filter=None, fields=None, **kwargs):|application/json|STABLE|
...
|GET /siem/offenses|def get_offenses(self, *, sort=None, Range=None, filter=None, fields=None, **kwargs):|application/json|STABLE|
...
|GET /siem/offenses/{offense_id}/notes|def get_offenses_notes_by_offense_id(self, offense_id, *, Range=None, filter=None, fields=None, **kwargs):|application/json|STABLE|
...
|GET /siem/remote_destination_addresses|def get_remote_destination_addresses(self, *, Range=None, filter=None, fields=None, **kwargs):|application/json|UNDOCUMENTED|
|GET /siem/source_addresses|def get_source_addresses(self, *, Range=None, filter=None, fields=None, **kwargs):|application/json|STABLE|
...
| API | QRadar4py | Return type | Visibility |
|-----|-----------|--------------|------------|
|GET /dashboards|def get(self, *, Range=None, filter=None, fields=None, **kwargs):|application/json|UNDOCUMENTED|
...
| API | QRadar4py | Return type | Visibility |
|-----|-----------|--------------|------------|
|GET /dynamic_search/schemas|def get_schemas(self, *, Range=None, filter=None, fields=None, **kwargs):|application/json|STABLE|
|GET /dynamic_search/schemas/{name}|def get_schemas_by_name(self, name, *, fields=None, **kwargs):|application/json|STABLE|
|GET /dynamic_search/schemas/{name}/fields|def get_schemas_fields_by_name(self, name, *, Range=None, filter=None, fields=None, **kwargs):|application/json|STABLE|
|GET /dynamic_search/schemas/{name}/functions|def get_schemas_functions_by_name(self, name, *, Range=None, filter=None, fields=None, **kwargs):|application/json|STABLE|
|GET /dynamic_search/schemas/{name}/operators|def get_schemas_operators_by_name(self, name, *, Range=None, filter=None, fields=None, **kwargs):|application/json|STABLE|
|GET /dynamic_search/searches|def get_searches(self, *, Range=None, filter=None, fields=None, **kwargs):|application/json|STABLE|
...
|GET /bandwidth_manager/configurations|def get_configurations(self, *, sort=None, Range=None, filter=None, fields=None, **kwargs):|application/json|STABLE|
...
|GET /bandwidth_manager/filters|def get_filters(self, *, sort=None, Range=None, filter=None, fields=None, **kwargs):|application/json|STABLE|
...
| API | QRadar4py | Return type | Visibility |
|-----|-----------|--------------|------------|
|GET /access/login_attempts|def get_login_attempts(self, *, sort=None, Range=None, filter=None, fields=None, **kwargs):|application/json|STABLE|
...
|GET /health_data/top_offenses|def get_top_offenses(self, *, Range=None, filter=None, fields=None, **kwargs):|application/json|STABLE|
|GET /health_data/top_rules|def get_top_rules(self, *, Range=None, filter=None, fields=None, **kwargs):|application/json|STABLE|

# usermanagement

| API | QRadar4py | Return type | Visibility |
|-----|-----------|--------------|------------|
|GET /usermanagement/users|def get_users(self, *, Range=None, filter=None, fields=None, **kwargs):|application/json|UNDOCUMENTED|
...
| API | QRadar4py | Return type | Visibility |
|-----|-----------|--------------|------------|
|GET /reports/groups|def get_groups(self, *, Range=None, filter=None, fields=None, **kwargs):|application/json|UNDOCUMENTED|
...
|GET /data_classification/high_level_categories|def get_high_level_categories(self, *, filter=None, fields=None, sort=None, Range=None, **kwargs):|application/json|STABLE|
...
|GET /data_classification/low_level_categories|def get_low_level_categories(self, *, filter=None, fields=None, sort=None, Range=None, **kwargs):|application/json|STABLE|
...
|GET /forensics/capture/recoveries|def get_capture_recoveries(self, *, filter=None, Range=None, fields=None, **kwargs):|application/json|STABLE|
...
|GET /forensics/capture/recovery_tasks|def get_capture_recovery_tasks(self, *, filter=None, Range=None, fields=None, **kwargs):|application/json|STABLE|
...
|GET /forensics/case_management/cases|def get_case_management_cases(self, *, filter=None, Range=None, fields=None, **kwargs):|application/json|STABLE|
...
|GET /historical_correlation/profiles|def get_profiles(self, *, Range=None, sort=None, fields=None, filter=None, **kwargs):|application/json|UNDOCUMENTED|
...
|GET /historical_correlation/profiles/{id}/runs|def get_profiles_runs_by_id(self, id, *, Range=None, sort=None, fields=None, filter=None, **kwargs):|application/json|UNDOCUMENTED|
...
| API | QRadar4py | Return type | Visibility |
|-----|-----------|--------------|------------|
|GET /internal/historical_correlation/hc_profiles|def get_historical_correlation_hc_profiles(self, *, Range=None, sort=None, fields=None, filter=None, **kwargs):|application/json|UNDOCUMENTED|
...
|GET /internal/system/servers/{server_id}/network_interfaces|def get_system_servers_network_interfaces_by_server_id(self, server_id, *, interface_types=None, Range=None, filter=None, fields=None, sort=None, **kwargs):|application/json|UNDOCUMENTED|
...
|GET /backup_and_restore/backups|def get_backups(self, *, fields=None, Range=None, filter=None, sort=None, **kwargs):|application/json|STABLE|
...
|GET /backup_and_restore/restores|def get_restores(self, *, fields=None, Range=None, filter=None, sort=None, **kwargs):|application/json|STABLE|
...
| API | QRadar4py | Return type | Visibility |
|-----|-----------|--------------|------------|
|GET /reporting/groups|def get_groups(self, *, filter=None, fields=None, Range=None, **kwargs):|application/json|UNDOCUMENTED|
...
|GET /reporting/templates|def get_templates(self, *, filter=None, fields=None, Range=None, **kwargs):|application/json|UNDOCUMENTED|
