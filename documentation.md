...
|GET /ariel/event_saved_search_groups|def get_event_saved_search_groups(self, *, filter=None, fields=None, Range=None, **kwargs):|application/json|STABLE|
...
|GET /ariel/flow_saved_search_groups|def get_flow_saved_search_groups(self, *, filter=None, fields=None, Range=None, **kwargs):|application/json|STABLE|
...
|GET /ariel/function/{function_name}|def get_function_by_function_name(self, function_name, *, filter=None, fields=None, Range=None, **kwargs):|application/json|UNDOCUMENTED|
|GET /ariel/functions|def get_functions(self, *, filter=None, fields=None, Range=None, **kwargs):|application/json|UNDOCUMENTED|
|POST /ariel/lookups|def post_lookups(self, *, data=None, fields=None, **kwargs):|application/json|UNDOCUMENTED|
|GET /ariel/lookups|def get_lookups(self, *, fields=None, **kwargs):|application/json|UNDOCUMENTED|
|GET /ariel/lookups/{name}|def get_lookups_by_name(self, name, *, fields=None, **kwargs):|application/json|UNDOCUMENTED|
|DELETE /ariel/lookups/{name}|def delete_lookups_by_name(self, name, *, fields=None, **kwargs):|application/json|UNDOCUMENTED|
|POST /ariel/lookups/{name}|def post_lookups_by_name(self, name, *, data=None, fields=None, **kwargs):|application/json|UNDOCUMENTED|
...
|GET /ariel/saved_searches|def get_saved_searches(self, *, filter=None, fields=None, Range=None, **kwargs):|application/json|STABLE|
...
|POST /ariel/searches|def post_searches(self, *, query_expression, **kwargs):|application/json|STABLE|
...
|GET /ariel/taggedfields|def get_taggedfields(self, *, catalog=None, fields=None, **kwargs):|application/json|UNDOCUMENTED|
|POST /ariel/taggedfields|def post_taggedfields(self, *, tag, name, catalog, type, array, format_class_name=None, format_params=None, description=None, fields=None, **kwargs):|application/json|UNDOCUMENTED|
|DELETE /ariel/taggedfields/{tag}|def delete_taggedfields_by_tag(self, tag, *, fields=None, **kwargs):|application/json|UNDOCUMENTED|
|POST /ariel/taggedfields/{tag}|def post_taggedfields_by_tag(self, tag, *, format_class_name=None, format_params=None, description=None, fields=None, **kwargs):|application/json|UNDOCUMENTED|
|GET /ariel/taggedfields/{tag}|def get_taggedfields_by_tag(self, tag, *, fields=None, **kwargs):|application/json|UNDOCUMENTED|
...
|GET /qvm/saved_search_groups|def get_saved_search_groups(self, *, fields=None, Range=None, filter=None, **kwargs):|application/json|STABLE|
...
|GET /qvm/saved_searches|def get_saved_searches(self, *, fields=None, Range=None, filter=None, **kwargs):|application/json|STABLE|
|GET /qvm/saved_searches/vuln_instances/{task_id}/results/assets|def get_saved_searches_vuln_instances_results_assets_by_task_id(self, task_id, *, fields=None, Range=None, filter=None, **kwargs):|application/json|STABLE|
|GET /qvm/saved_searches/vuln_instances/{task_id}/results/vuln_instances|def get_saved_searches_vuln_instances_results_vuln_instances_by_task_id(self, task_id, *, fields=None, Range=None, filter=None, **kwargs):|application/json|STABLE|
|GET /qvm/saved_searches/vuln_instances/{task_id}/results/vulnerabilities|def get_saved_searches_vuln_instances_results_vulnerabilities_by_task_id(self, task_id, *, fields=None, Range=None, filter=None, **kwargs):|application/json|STABLE|
...
|GET /qvm/saved_searches/{saved_search_id}/vuln_instances|def get_saved_searches_vuln_instances_by_saved_search_id(self, saved_search_id, *, fields=None, Range=None, filter=None, **kwargs):|application/json|STABLE|
...
| API | QRadar4py | Return type | Visibility |
|-----|-----------|--------------|------------|
|GET /asset_model/assets|def get_assets(self, *, fields=None, Range=None, filter=None, **kwargs):|application/json|STABLE|
|POST /asset_model/assets/{asset_id}|def post_assets_by_asset_id(self, asset_id, *, asset, **kwargs):|text/plain|STABLE|
|GET /asset_model/properties|def get_properties(self, *, fields=None, Range=None, filter=None, **kwargs):|application/json|STABLE|
|GET /asset_model/saved_search_groups|def get_saved_search_groups(self, *, fields=None, Range=None, filter=None, **kwargs):|application/json|STABLE|
...
|GET /asset_model/saved_searches|def get_saved_searches(self, *, fields=None, Range=None, filter=None, **kwargs):|application/json|STABLE|
...
|GET /asset_model/saved_searches/{saved_search_id}/results|def get_saved_searches_results_by_saved_search_id(self, saved_search_id, *, fields=None, Range=None, filter=None, **kwargs):|application/json|STABLE|

# system

| API | QRadar4py | Return type | Visibility |
|-----|-----------|--------------|------------|
|GET /system/authorization/capabilities|def get_authorization_capabilities(self, *, Range=None, fields=None, filter=None, **kwargs):|application/json|UNDOCUMENTED|
|GET /system/authorization/password_policies|def get_authorization_password_policies(self, *, Range=None, fields=None, filter=None, **kwargs):|application/json|STABLE|
...
|POST /system/authorization/password_validators|def post_authorization_password_validators(self, *, password, fields=None, **kwargs):|application/json|STABLE|
|GET /system/eula_acceptance|def get_eula_acceptance(self, **kwargs):|application/json|UNDOCUMENTED|
|POST /system/eula_acceptance/{id}|def post_eula_acceptance_by_id(self, id, *, data, fields=None, **kwargs):|application/json|UNDOCUMENTED|
|GET /system/eula_acceptance/{id}|def get_eula_acceptance_by_id(self, id, **kwargs):|application/json|UNDOCUMENTED|
|GET /system/eulas|def get_eulas(self, **kwargs):|application/json|UNDOCUMENTED|
|GET /system/information/encodings|def get_information_encodings(self, *, Range=None, fields=None, filter=None, **kwargs):|application/json|STABLE|
|GET /system/information/locales|def get_information_locales(self, *, sample_type=None, filter=None, Range=None, fields=None, **kwargs):|application/json|STABLE|
|GET /system/locales|def get_locales(self, *, filter=None, sort=None, Range=None, fields=None, **kwargs):|application/json|UNDOCUMENTED|
...
|GET /system/task_management/subtasks|def get_task_management_subtasks(self, *, filter=None, Range=None, fields=None, **kwargs):|application/json|UNDOCUMENTED|
...
|GET /system/task_management/task|def get_task_management_task(self, *, filter=None, Range=None, fields=None, **kwargs):|application/json|UNDOCUMENTED|
...
|GET /system/task_management/tasks|def get_task_management_tasks(self, *, filter=None, Range=None, fields=None, **kwargs):|application/json|UNDOCUMENTED|
...
| API | QRadar4py | Return type | Visibility |
|-----|-----------|--------------|------------|
|GET /config/access/authorized_services|def get_access_authorized_services(self, *, Range=None, fields=None, filter=None, **kwargs):|application/json|UNDOCUMENTED|
...
|GET /config/access/roles|def get_access_roles(self, *, Range=None, fields=None, filter=None, **kwargs):|application/json|UNDOCUMENTED|
|GET /config/access/roles/{id}|def get_access_roles_by_id(self, id, *, fields=None, **kwargs):|application/json|UNDOCUMENTED|
|GET /config/access/staged_authorized_services|def get_access_staged_authorized_services(self, *, Range=None, fields=None, filter=None, **kwargs):|application/json|UNDOCUMENTED|
...
|GET /config/access/staged_roles|def get_access_staged_roles(self, *, Range=None, fields=None, filter=None, **kwargs):|application/json|UNDOCUMENTED|
...
|GET /config/access/tenant_management/tenants|def get_access_tenant_management_tenants(self, *, Range=None, fields=None, filter=None, **kwargs):|application/json|STABLE|
...
|GET /config/access/users|def get_access_users(self, *, Range=None, fields=None, filter=None, **kwargs):|application/json|STABLE|
...
|GET /config/access/users_with_capability_filter|def get_access_users_with_capability_filter(self, *, capabilities, Range=None, fields=None, filter=None, **kwargs):|application/json|UNDOCUMENTED|
|GET /config/access_control/roles|def get_access_control_roles(self, *, Range=None, fields=None, filter=None, **kwargs):|application/json|UNDOCUMENTED|
...
|GET /config/access_control/users|def get_access_control_users(self, *, Range=None, fields=None, filter=None, **kwargs):|application/json|UNDOCUMENTED|
...
|GET /config/deployment/node_details/{node_ip}|def get_deployment_node_details_by_node_ip(self, node_ip, *, fields=None, **kwargs):|application/json|UNDOCUMENTED|
|GET /config/deployment/node_modification_task/{task_id}|def get_deployment_node_modification_task_by_task_id(self, task_id, *, fields=None, **kwargs):|application/json|UNDOCUMENTED|
|POST /config/deployment/nodes|def post_deployment_nodes(self, *, node, fields=None, **kwargs):|application/json|UNDOCUMENTED|
|GET /config/deployment/nodes|def get_deployment_nodes(self, *, fields=None, filter=None, sort=None, Range=None, **kwargs):|application/json|UNDOCUMENTED|
|GET /config/deployment/nodes/hostkeys/{ip}|def get_deployment_nodes_hostkeys_by_ip(self, ip, *, fields=None, **kwargs):|application/json|UNDOCUMENTED|
|GET /config/deployment/nodes/{node_id}|def get_deployment_nodes_by_node_id(self, node_id, *, fields=None, **kwargs):|application/json|UNDOCUMENTED|
|DELETE /config/deployment/nodes/{node_id}|def delete_deployment_nodes_by_node_id(self, node_id, *, removal_type, fields=None, **kwargs):|application/json|UNDOCUMENTED|
...
|GET /config/domain_management/domains|def get_domain_management_domains(self, *, Range=None, fields=None, filter=None, **kwargs):|application/json|STABLE|
...
|GET /config/event_retention_buckets|def get_event_retention_buckets(self, *, Range=None, fields=None, filter=None, **kwargs):|application/json|STABLE|
...
|GET /config/event_sources/custom_properties/calculated_properties|def get_event_sources_custom_properties_calculated_properties(self, *, fields=None, filter=None, Range=None, **kwargs):|application/json|STABLE|
...
|GET /config/event_sources/custom_properties/property_expressions|def get_event_sources_custom_properties_property_expressions(self, *, fields=None, filter=None, Range=None, **kwargs):|application/json|STABLE|
...
|GET /config/event_sources/custom_properties/property_json_expressions|def get_event_sources_custom_properties_property_json_expressions(self, *, fields=None, filter=None, Range=None, **kwargs):|application/json|STABLE|
...
|GET /config/event_sources/custom_properties/regex_properties|def get_event_sources_custom_properties_regex_properties(self, *, fields=None, filter=None, Range=None, **kwargs):|application/json|STABLE|
...
|GET /config/event_sources/event_collectors|def get_event_sources_event_collectors(self, *, fields=None, filter=None, Range=None, **kwargs):|application/json|STABLE|
...
|GET /config/event_sources/log_source_extensions|def get_event_sources_log_source_extensions(self, *, fields=None, filter=None, Range=None, **kwargs):|application/json|UNDOCUMENTED|
...
|GET /config/event_sources/log_source_management/autodetection/config_records|def get_event_sources_log_source_management_autodetection_config_records(self, *, filter=None, fields=None, Range=None, **kwargs):|application/json|STABLE|
...
|GET /config/event_sources/log_source_management/log_source_extensions|def get_event_sources_log_source_management_log_source_extensions(self, *, fields=None, filter=None, Range=None, **kwargs):|application/json|STABLE|
...
|GET /config/event_sources/log_source_management/log_source_groups|def get_event_sources_log_source_management_log_source_groups(self, *, fields=None, filter=None, Range=None, **kwargs):|application/json|STABLE|
...
|GET /config/event_sources/log_source_management/log_source_languages|def get_event_sources_log_source_management_log_source_languages(self, *, fields=None, filter=None, Range=None, **kwargs):|application/json|STABLE|
...
|GET /config/event_sources/log_source_management/log_source_types|def get_event_sources_log_source_management_log_source_types(self, *, fields=None, filter=None, Range=None, **kwargs):|application/json|STABLE|
...
|GET /config/event_sources/log_source_management/log_sources|def get_event_sources_log_source_management_log_sources(self, *, fields=None, filter=None, sort=None, Range=None, **kwargs):|application/json|STABLE|
...
|GET /config/event_sources/log_source_management/protocol_types|def get_event_sources_log_source_management_protocol_types(self, *, fields=None, filter=None, Range=None, **kwargs):|application/json|STABLE|
...
|GET /config/event_sources/property_discovery_profiles|def get_event_sources_property_discovery_profiles(self, *, fields=None, filter=None, Range=None, **kwargs):|application/json|STABLE|
...
|GET /config/event_sources/wincollect/wincollect_agents|def get_event_sources_wincollect_wincollect_agents(self, *, fields=None, filter=None, Range=None, **kwargs):|application/json|STABLE|
...
|GET /config/event_sources/wincollect/wincollect_destinations|def get_event_sources_wincollect_wincollect_destinations(self, *, fields=None, filter=None, Range=None, **kwargs):|application/json|STABLE|
...
|GET /config/extension_management/extensions|def get_extension_management_extensions(self, *, Range=None, sort=None, fields=None, filter=None, **kwargs):|application/json|STABLE|
...
|DELETE /config/extension_management/extensions/{extension_id}|def delete_extension_management_extensions_by_extension_id(self, extension_id, *, fields=None, **kwargs):|application/json|STABLE|
...
|GET /config/flow_retention_buckets|def get_flow_retention_buckets(self, *, Range=None, fields=None, filter=None, **kwargs):|application/json|STABLE|
...
|GET /config/flow_sources/custom_properties/calculated_properties|def get_flow_sources_custom_properties_calculated_properties(self, *, fields=None, filter=None, Range=None, **kwargs):|application/json|STABLE|
...
|GET /config/flow_sources/custom_properties/property_expressions|def get_flow_sources_custom_properties_property_expressions(self, *, fields=None, filter=None, Range=None, **kwargs):|application/json|STABLE|
...
|GET /config/flow_sources/custom_properties/regex_properties|def get_flow_sources_custom_properties_regex_properties(self, *, fields=None, filter=None, Range=None, **kwargs):|application/json|STABLE|
...
|GET /config/global_system_notifications|def get_global_system_notifications(self, *, Range=None, fields=None, filter=None, **kwargs):|application/json|STABLE|
...
|GET /config/log_sources/log_source_groups|def get_log_sources_log_source_groups(self, *, fields=None, filter=None, Range=None, **kwargs):|application/json|UNDOCUMENTED|
...
|GET /config/remote_networks|def get_remote_networks(self, *, Range=None, fields=None, filter=None, **kwargs):|application/json|STABLE|
...
|GET /config/remote_services|def get_remote_services(self, *, Range=None, fields=None, filter=None, **kwargs):|application/json|STABLE|
...
|GET /config/resource_restriction/users_by_tenant/{tenant_id}|def get_resource_restriction_users_by_tenant_by_tenant_id(self, tenant_id, *, Range=None, fields=None, filter=None, **kwargs):|application/json|UNDOCUMENTED|
...
|GET /config/resource_restrictions|def get_resource_restrictions(self, *, Range=None, fields=None, filter=None, **kwargs):|application/json|STABLE|
...
|GET /config/selective_forwarding/destinations|def get_selective_forwarding_destinations(self, *, Range=None, fields=None, filter=None, **kwargs):|application/json|UNDOCUMENTED|
...
|GET /config/selective_forwarding/routes|def get_selective_forwarding_routes(self, *, Range=None, fields=None, filter=None, **kwargs):|application/json|UNDOCUMENTED|
...
|GET /config/store_and_forward/policies|def get_store_and_forward_policies(self, *, Range=None, fields=None, filter=None, **kwargs):|application/json|STABLE|
...
| API | QRadar4py | Return type | Visibility |
|-----|-----------|--------------|------------|
|GET /configuration/log_source_groups|def get_log_source_groups(self, *, fields=None, filter=None, Range=None, **kwargs):|application/json|UNDOCUMENTED|
...
|GET /configuration/log_source_protocols|def get_log_source_protocols(self, *, fields=None, filter=None, Range=None, **kwargs):|application/json|UNDOCUMENTED|
|GET /configuration/log_source_types|def get_log_source_types(self, *, excludeSystemTypes=None, fields=None, filter=None, sort=None, Range=None, **kwargs):|application/json|UNDOCUMENTED|
...
|GET /configuration/log_sources|def get_log_sources(self, *, show_deleted=None, fields=None, filter=None, Range=None, **kwargs):|application/json|UNDOCUMENTED|
...
|POST /configuration/newhost|def post_newhost(self, *, host=None, properties=None, capabilities=None, fields=None, **kwargs):|application/json|UNDOCUMENTED|
...
|POST /qni/hosts/{host_id}/configs/{id}|def post_hosts_host_id_configs_by_id(self, host_id, id, *, qni_port_configuration, fields=None, **kwargs):|application/json|STABLE|
...
|GET /staged_config/access/users|def get_access_users(self, *, Range=None, fields=None, filter=None, **kwargs):|application/json|STABLE|
...
|GET /staged_config/access/users_with_capability_filter|def get_access_users_with_capability_filter(self, *, capabilities, Range=None, fields=None, filter=None, **kwargs):|application/json|UNDOCUMENTED|
...
|GET /staged_config/access_control/users|def get_access_control_users(self, *, Range=None, fields=None, filter=None, **kwargs):|application/json|UNDOCUMENTED|
...
|GET /staged_config/global_system_notifications|def get_global_system_notifications(self, *, Range=None, fields=None, filter=None, **kwargs):|application/json|STABLE|
...
|GET /staged_config/remote_networks|def get_remote_networks(self, *, Range=None, fields=None, filter=None, **kwargs):|application/json|STABLE|
...
|GET /staged_config/remote_services|def get_remote_services(self, *, Range=None, fields=None, filter=None, **kwargs):|application/json|STABLE|
...
| API | QRadar4py | Return type | Visibility |
|-----|-----------|--------------|------------|
|GET /internal/historical_correlation/hc_profiles|def get_historical_correlation_hc_profiles(self, *, fields=None, Range=None, sort=None, filter=None, **kwargs):|application/json|UNDOCUMENTED|
...
|GET /internal/system/servers/{server_id}/network_interfaces|def get_system_servers_network_interfaces_by_server_id(self, server_id, *, interface_types=None, filter=None, sort=None, Range=None, fields=None, **kwargs):|application/json|UNDOCUMENTED|

# g11n

| API | QRadar4py | Return type | Visibility |
|-----|-----------|--------------|------------|
|GET /g11n/locale|def get_locale(self, *, filter=None, Range=None, fields=None, **kwargs):|application/json|UNDOCUMENTED|
...
|GET /application/data_ingestion/payloads|def get_data_ingestion_payloads(self, *, handle_id, ids, filter=None, Range=None, fields=None, **kwargs):|application/json|UNDOCUMENTED|
...
|GET /application/data_ingestion/qid_records|def get_data_ingestion_qid_records(self, *, qid=None, name=None, low_level_category_id=None, high_level_category_id=None, log_source_type_id=None, fields=None, filter=None, sort=None, Range=None, **kwargs):|application/json|UNDOCUMENTED|
...
| API | QRadar4py | Return type | Visibility |
|-----|-----------|--------------|------------|
|GET /siem/local_destination_addresses|def get_local_destination_addresses(self, *, Range=None, fields=None, filter=None, **kwargs):|application/json|STABLE|
...
|GET /siem/offense_closing_reasons|def get_offense_closing_reasons(self, *, include_reserved=None, include_deleted=None, Range=None, fields=None, filter=None, **kwargs):|application/json|STABLE|
...
|GET /siem/offense_saved_search_groups|def get_offense_saved_search_groups(self, *, Range=None, fields=None, filter=None, **kwargs):|application/json|STABLE|
...
|GET /siem/offense_saved_searches|def get_offense_saved_searches(self, *, Range=None, fields=None, filter=None, **kwargs):|application/json|STABLE|
|DELETE /siem/offense_saved_searches/{id}|def delete_offense_saved_searches_by_id(self, id, *, Range=None, fields=None, filter=None, **kwargs):|application/json|STABLE|
|POST /siem/offense_saved_searches/{id}|def post_offense_saved_searches_by_id(self, id, *, saved_search, Range=None, fields=None, filter=None, **kwargs):|application/json|STABLE|
|GET /siem/offense_saved_searches/{id}|def get_offense_saved_searches_by_id(self, id, *, Range=None, fields=None, filter=None, **kwargs):|application/json|STABLE|
...
|GET /siem/offense_types|def get_offense_types(self, *, Range=None, sort=None, fields=None, filter=None, **kwargs):|application/json|STABLE|
...
|GET /siem/offenses|def get_offenses(self, *, Range=None, sort=None, fields=None, filter=None, **kwargs):|application/json|STABLE|
...
|GET /siem/offenses/{offense_id}/notes|def get_offenses_notes_by_offense_id(self, offense_id, *, Range=None, fields=None, filter=None, **kwargs):|application/json|STABLE|
...
|GET /siem/source_addresses|def get_source_addresses(self, *, Range=None, fields=None, filter=None, **kwargs):|application/json|STABLE|
...
|GET /reference_data/map_of_sets|def get_map_of_sets(self, *, Range=None, fields=None, filter=None, **kwargs):|application/json|STABLE|
...
|GET /reference_data/map_of_sets/{name}|def get_map_of_sets_by_name(self, name, *, Range=None, fields=None, **kwargs):|application/json|STABLE|
...
|GET /reference_data/maps|def get_maps(self, *, Range=None, fields=None, filter=None, **kwargs):|application/json|STABLE|
...
|GET /reference_data/maps/{name}|def get_maps_by_name(self, name, *, Range=None, fields=None, filter=None, **kwargs):|application/json|STABLE|
...
|GET /reference_data/sets|def get_sets(self, *, Range=None, fields=None, filter=None, **kwargs):|application/json|STABLE|
...
|GET /reference_data/sets/search|def get_sets_search(self, *, value, Range=None, fields=None, filter=None, **kwargs):|application/json|UNDOCUMENTED|
...
|GET /reference_data/sets/{name}|def get_sets_by_name(self, name, *, Range=None, fields=None, filter=None, **kwargs):|application/json|STABLE|
...
|GET /reference_data/tables|def get_tables(self, *, Range=None, fields=None, filter=None, **kwargs):|application/json|STABLE|
...
|GET /reference_data/tables/{name}|def get_tables_by_name(self, name, *, Range=None, fields=None, **kwargs):|application/json|STABLE|
...
| API | QRadar4py | Return type | Visibility |
|-----|-----------|--------------|------------|
|GET /analytics/ade_rules|def get_ade_rules(self, *, filter=None, fields=None, Range=None, **kwargs):|application/json|STABLE|
...
|GET /analytics/building_blocks|def get_building_blocks(self, *, Range=None, fields=None, filter=None, **kwargs):|application/json|STABLE|
...
|GET /analytics/custom_actions/actions|def get_custom_actions_actions(self, *, Range=None, fields=None, filter=None, **kwargs):|application/json|STABLE|
...
|GET /analytics/custom_actions/interpreters|def get_custom_actions_interpreters(self, *, Range=None, fields=None, filter=None, **kwargs):|application/json|STABLE|
...
|GET /analytics/custom_actions/scripts|def get_custom_actions_scripts(self, *, Range=None, fields=None, filter=None, **kwargs):|application/json|STABLE|
...
|GET /analytics/rule_groups|def get_rule_groups(self, *, Range=None, fields=None, filter=None, **kwargs):|application/json|STABLE|
...
|GET /analytics/rules|def get_rules(self, *, Range=None, fields=None, filter=None, **kwargs):|application/json|STABLE|
...
|GET /health_data/top_offenses|def get_top_offenses(self, *, Range=None, fields=None, filter=None, **kwargs):|application/json|STABLE|
|GET /health_data/top_rules|def get_top_rules(self, *, Range=None, fields=None, filter=None, **kwargs):|application/json|STABLE|

# usermanagement

| API | QRadar4py | Return type | Visibility |
|-----|-----------|--------------|------------|
|GET /usermanagement/users|def get_users(self, *, Range=None, fields=None, filter=None, **kwargs):|application/json|UNDOCUMENTED|
...
| API | QRadar4py | Return type | Visibility |
|-----|-----------|--------------|------------|
|GET /dashboards|def get(self, *, Range=None, fields=None, filter=None, **kwargs):|application/json|UNDOCUMENTED|
...
| API | QRadar4py | Return type | Visibility |
|-----|-----------|--------------|------------|
|GET /qrm/model_groups|def get_model_groups(self, *, Range=None, fields=None, filter=None, **kwargs):|application/json|STABLE|
...
|GET /qrm/qrm_saved_search_groups|def get_qrm_saved_search_groups(self, *, Range=None, fields=None, filter=None, **kwargs):|application/json|STABLE|
...
|GET /qrm/question_groups|def get_question_groups(self, *, Range=None, fields=None, filter=None, **kwargs):|application/json|STABLE|
...
|GET /qrm/simulation_groups|def get_simulation_groups(self, *, Range=None, fields=None, filter=None, **kwargs):|application/json|STABLE|
...
|GET /qrm/topology_saved_search_groups|def get_topology_saved_search_groups(self, *, Range=None, fields=None, filter=None, **kwargs):|application/json|STABLE|
...
|GET /health/metrics/config|def get_metrics_config(self, *, Range=None, fields=None, filter=None, **kwargs):|application/json|UNDOCUMENTED|
...
|GET /health/metrics/meta|def get_metrics_meta(self, *, Range=None, fields=None, filter=None, **kwargs):|application/json|UNDOCUMENTED|
...
| API | QRadar4py | Return type | Visibility |
|-----|-----------|--------------|------------|
|GET /reports/groups|def get_groups(self, *, Range=None, fields=None, filter=None, **kwargs):|application/json|UNDOCUMENTED|
...
|GET /data_classification/dsm_event_mappings|def get_dsm_event_mappings(self, *, fields=None, filter=None, Range=None, **kwargs):|application/json|STABLE|
...
|GET /data_classification/high_level_categories|def get_high_level_categories(self, *, fields=None, filter=None, sort=None, Range=None, **kwargs):|application/json|STABLE|
...
|GET /data_classification/low_level_categories|def get_low_level_categories(self, *, fields=None, filter=None, sort=None, Range=None, **kwargs):|application/json|STABLE|
...
|GET /data_classification/qid_records|def get_qid_records(self, *, fields=None, filter=None, Range=None, **kwargs):|application/json|STABLE|
...
|GET /historical_correlation/potential_event_rules|def get_potential_event_rules(self, *, fields=None, Range=None, filter=None, **kwargs):|application/json|UNDOCUMENTED|
|GET /historical_correlation/potential_event_saved_searches|def get_potential_event_saved_searches(self, *, fields=None, Range=None, filter=None, **kwargs):|application/json|UNDOCUMENTED|
|GET /historical_correlation/potential_flow_rules|def get_potential_flow_rules(self, *, fields=None, Range=None, filter=None, **kwargs):|application/json|UNDOCUMENTED|
|GET /historical_correlation/potential_flow_saved_searches|def get_potential_flow_saved_searches(self, *, fields=None, Range=None, filter=None, **kwargs):|application/json|UNDOCUMENTED|
|GET /historical_correlation/profiles|def get_profiles(self, *, fields=None, Range=None, sort=None, filter=None, **kwargs):|application/json|UNDOCUMENTED|
...
|GET /historical_correlation/profiles/{id}/runs|def get_profiles_runs_by_id(self, id, *, fields=None, Range=None, sort=None, filter=None, **kwargs):|application/json|UNDOCUMENTED|
...
|GET /gui_app_framework/application_creation_task|def get_application_creation_task(self, *, Range=None, fields=None, filter=None, **kwargs):|application/json|STABLE|
...
|GET /help/endpoints|def get_endpoints(self, *, filter=None, Range=None, fields=None, **kwargs):|application/json|STABLE|
...
|GET /help/resources|def get_resources(self, *, filter=None, Range=None, fields=None, **kwargs):|application/json|STABLE|
...
|GET /help/versions|def get_versions(self, *, filter=None, Range=None, fields=None, **kwargs):|application/json|STABLE|
