...
class ReferenceData(QRadarAPIEndpoint):
    ...
    def delete_map_of_sets_by_name(self, name, *, purge_only=None, fields=None, **kwargs):
        """
    ...
    @request_vars('value', 'fields')
    def delete_map_of_sets_name_by_key(self, name, key, *, value, fields=None, **kwargs):
        """
    ...
    @request_vars('value', 'fields')
    def delete_maps_name_by_key(self, name, key, *, value, fields=None, **kwargs):
        """
    ...
    @request_vars('purge_only', 'fields')
    def delete_sets_by_name(self, name, *, purge_only=None, fields=None, **kwargs):
        """
    ...
    @request_vars('fields')
    def delete_sets_name_by_value(self, name, value, *, fields=None, **kwargs):
        """
    ...
    @request_vars('purge_only', 'fields')
    def delete_tables_by_name(self, name, *, purge_only=None, fields=None, **kwargs):
        """
    ...
    @request_vars('value', 'fields')
    def delete_tables_name_outer_key_by_inner_key(self, name, outer_key, inner_key, *, value, fields=None, **kwargs):
        """
