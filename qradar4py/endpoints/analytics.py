...
class Analytics(QRadarAPIEndpoint):
    ...
    def get_ade_rules(self, *, filter=None, fields=None, Range=None, **kwargs):
        """
    ...
    def get_building_blocks(self, *, Range=None, fields=None, filter=None, **kwargs):
        """
    ...
    @header_vars('Range')
    @request_vars('fields', 'filter')
    def get_custom_actions_actions(self, *, Range=None, fields=None, filter=None, **kwargs):
        """
    ...
    @header_vars('Range')
    @request_vars('fields', 'filter')
    def get_custom_actions_interpreters(self, *, Range=None, fields=None, filter=None, **kwargs):
        """
    ...
    @header_vars('Range')
    @request_vars('fields', 'filter')
    def get_custom_actions_scripts(self, *, Range=None, fields=None, filter=None, **kwargs):
        """
    ...
    @header_vars('Range')
    @request_vars('fields', 'filter')
    def get_rule_groups(self, *, Range=None, fields=None, filter=None, **kwargs):
        """
    ...
    @header_vars('Range')
    @request_vars('fields', 'filter')
    def get_rules(self, *, Range=None, fields=None, filter=None, **kwargs):
        """
        GET /analytics/rules
