...
class Internal(QRadarAPIEndpoint):
    ...
    def get_historical_correlation_hc_profiles(self, *, fields=None, Range=None, sort=None, filter=None, **kwargs):
        """
    ...
    def get_system_servers_network_interfaces_by_server_id(self, server_id, *, interface_types=None, filter=None,
                                                           sort=None, Range=None, fields=None, **kwargs):
        """
