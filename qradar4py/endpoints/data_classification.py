...
class DataClassification(QRadarAPIEndpoint):
    ...
    def get_dsm_event_mappings(self, *, fields=None, filter=None, Range=None, **kwargs):
        """
    ...
    def get_high_level_categories(self, *, fields=None, filter=None, sort=None, Range=None, **kwargs):
        """
    ...
    @header_vars('Range')
    @request_vars('fields', 'filter', 'sort')
    def get_low_level_categories(self, *, fields=None, filter=None, sort=None, Range=None, **kwargs):
        """
    ...
    @header_vars('Range')
    @request_vars('fields', 'filter')
    def get_qid_records(self, *, fields=None, filter=None, Range=None, **kwargs):
        """
